...
files = [r"""../mnist_conv_models/conv_nlayers=1_nfeatures=32/log/validation""",
         r"""../mnist_conv_models/conv_nlayers=2_nfeatures=32-64/log/validation""",
         r"""../mnist_conv_models/conv_lenet5_morereg/log/validation"""
         ]

scalar_names = ['accuracy_1', 'cross_entropy_1']
ylabels = ['Validation Accuracy', 'Cross Entropy (Validation Set)']
legend = [r'$n_{layers}=1, n_{units}=32$', r'$n_{layers}=1, n_{units}=32-64$', r'lenet5 model']
